...
R1 nach Formel Formel \ref{omega}\ (siehe Formel (6a) in der Aufgabenstellung) berechnen: R1 = 31.5k$\Omega$. Da die Kondensatoren vorgegeben sind (C = 10nF), existiert kein Freiheitsgrad mehr und die Widerstände können alle exakt berechnet werden.
