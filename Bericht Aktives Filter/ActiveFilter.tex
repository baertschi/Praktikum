...
C  = C1 = C2 = 10nF und C3 = $\frac{1}{2} C$ = 4.7nF
...
$R_{off}$ = 39k$\Omega$ (gewählt: 39k$\Omega$, E12)

$R0 \cdot (\beta - 1)$ = 1.53 ist aufgeteilt in $R_{01}$ und $R_{02}$. Serieschaltung 1k$\Omega$ + 2k$\Omega$ Poti.
...
Das Ergebnis der Simulation stimmt recht genau mit dem gemessenen Ergebnis überein. Jedoch ist die Mittenfrequenz nicht genau gleich abgestimmt. Die Bandbreite der Simulation beträgt 
...
\subsection{Messung}
Um zu schauen wie sich das Filter verhält und ob es gut dimensioniert ist, haben wir den Amplitudengang und den Phasengang gemessen. Dabei haben wir vor allem im Bereich der Mittenfrequenz einige Punkte erfasst. 
