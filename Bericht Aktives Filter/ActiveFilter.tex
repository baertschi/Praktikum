...
\subsubsection{Beta}
Der zweite Schritt ist, die Verstärkung $\beta$ zu berechnen. Dies geschieht mit der Formel 8, welche wir nach $\beta$ umgestellt haben. Dies ergibt zwei Lösungen, da die Gleichung vom Grad 2 ist. Laut der Aufgabenstellung ist es besser für die Empfindlichkeit den tieferen Wert der beiden zu wählen. So kommen wir auf $\beta$ = 2.53.
...
R1 nach Formel 6a berechnen: R1 = 31.5k$\Omega$. Da die Kondensatoren vorgegeben sind (C = 10nF), existiert kein Freiheitsgrad mehr und die Widerstände können alle exakt berechnet werden.
