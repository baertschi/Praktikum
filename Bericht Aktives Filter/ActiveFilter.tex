...
Das Ergebnis der Simulation in \autoref{simulation_bode} stimmt recht genau mit dem gemessenen Ergebnis überein. Jedoch ist die Mittenfrequenz nicht genau gleich abgestimmt.
...
\begin{tabular}{rr}
	...
	\\
	\toprule
	\scriptsize{Datum und Unterschrift}	\hspace{3cm}	&	\textsc{Dario Colombo}	\\
	\\
	\\
	\\
	\\
